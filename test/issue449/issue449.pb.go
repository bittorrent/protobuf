...
var fileDescriptor_dece653619274e1d = []byte{
	...
	0xf1, 0x48, 0x8e, 0x11, 0x10, 0x00, 0x00, 0xff, 0xff, 0x15, 0xa8, 0x82, 0x57, 0x9f, 0x01, 0x00,
	0x00,
}
...
func (m *CodeGenMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Int64ReqPtr == nil {
		return 0, github_com_tron_us_protobuf_proto.NewRequiredNotSetError("Int64ReqPtr")
	} else {
...
func (m *CodeGenMsg) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_tron_us_protobuf_proto.NewRequiredNotSetError("Int64ReqPtr")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_tron_us_protobuf_proto.NewRequiredNotSetError("Int64Req")
	}
