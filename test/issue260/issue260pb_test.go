...
func BenchmarkDroppedProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_bittorrent_protobuf_proto.Marshal(NewPopulatedDropped(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkDroppedWithoutGettersProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_bittorrent_protobuf_proto.Marshal(NewPopulatedDroppedWithoutGetters(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkKeptProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_bittorrent_protobuf_proto.Marshal(NewPopulatedKept(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
