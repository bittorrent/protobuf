...
func BenchmarkBigProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedBig(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkBigUnsafeProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedBigUnsafe(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkSubProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedSub(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkIntMergeProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedIntMerge(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
