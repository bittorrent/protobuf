...
import (
	...
	proto1 "github.com/tron-us/protobuf/test/importduplicate/proto"
	sortkeys "github.com/tron-us/protobuf/test/importduplicate/sortkeys"
	math "math"
	reflect "reflect"
	strings "strings"
)
...
var fileDescriptor_f3b420b76fd5209f = []byte{
	...
	0xcf, 0xd5, 0x2f, 0x29, 0xca, 0xcf, 0xd3, 0x2d, 0x2d, 0xd6, 0x07, 0x2b, 0x4d, 0x2a, 0x4d, 0xd3,
	...
	0x00, 0xff, 0xff, 0x0c, 0x3f, 0xfd, 0x0a, 0xe7, 0x01, 0x00, 0x00,
}
...
func (this *MapAndSortKeys) GoString() string {
	...
	github_com_tron_us_protobuf_sortkeys.Int32s(keysForKeyValue)
