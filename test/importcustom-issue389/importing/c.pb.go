...
import (
	...
	_ "github.com/bittorrent/protobuf/test/importcustom-issue389/imported"
	github_com_bittorrent_protobuf_test_importcustom_issue389_imported "github.com/bittorrent/protobuf/test/importcustom-issue389/imported"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type C struct {
	F2                   *github_com_bittorrent_protobuf_test_importcustom_issue389_imported.B `protobuf:"bytes,1,opt,name=f2,proto3,customtype=github.com/bittorrent/protobuf/test/importcustom-issue389/imported.B" json:"f2,omitempty" pg:"f2"`
...
var fileDescriptor_7086c139101e99ef = []byte{
	...
	,
}
...
func NewPopulatedC(r randyC, easy bool) *C {
	this := &C{}
	if r.Intn(5) != 0 {
		this.F2 = github_com_bittorrent_protobuf_test_importcustom_issue389_imported.NewPopulatedB(r)
	}
	if !easy && r.Intn(10) != 0 {
...
func (m *C) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.F2 == nil {
				m.F2 = &github_com_bittorrent_protobuf_test_importcustom_issue389_imported.B{}
			}
