...
import (
	...
	_ "github.com/tron-us/protobuf/test/importcustom-issue389/imported"
	github_com_tron_us_protobuf_test_importcustom_issue389_imported "github.com/tron-us/protobuf/test/importcustom-issue389/imported"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
var fileDescriptor_7086c139101e99ef = []byte{
	...
	,
}
...
func NewPopulatedC(r randyC, easy bool) *C {
	this := &C{}
	if r.Intn(5) != 0 {
		this.F2 = github_com_tron_us_protobuf_test_importcustom_issue389_imported.NewPopulatedB(r)
	}
	if !easy && r.Intn(10) != 0 {
...
func (m *C) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.F2 == nil {
				m.F2 = &github_com_tron_us_protobuf_test_importcustom_issue389_imported.B{}
			}
