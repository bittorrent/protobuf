...
var fileDescriptor_395e61815f86626a = []byte{
	...
	0xe4, 0x1c, 0xed, 0x55, 0xf6, 0x00, 0x00, 0x00,
}
...
func (m *TimeFail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TimeTest != nil {
		n1, err1 := github_com_tron_us_protobuf_types.StdTimeMarshalTo(*m.TimeTest, dAtA[i-github_com_tron_us_protobuf_types.SizeOfStdTime(*m.TimeTest):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
...
func (m *TimeFail) Size() (n int) {
	...
	_ = l
	if m.TimeTest != nil {
		l = github_com_tron_us_protobuf_types.SizeOfStdTime(*m.TimeTest)
...
func (m *TimeFail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_tron_us_protobuf_types.StdTimeUnmarshal(m.TimeTest, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
