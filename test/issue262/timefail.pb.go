...
type TimeFail struct {
	TimeTest *time.Time `protobuf:"bytes,1,opt,name=time_test,json=timeTest,proto3,stdtime" json:"time_test,omitempty" pg:"time_test"`
}
...
var fileDescriptor_395e61815f86626a = []byte{
	...
	0x4d, 0x4b, 0xcc, 0xcc, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0xf1, 0xa5, 0x8c,
	...
	0xc1, 0x1c, 0x30, 0x0b, 0xa2, 0x5d, 0x4a, 0x3e, 0x3d, 0x3f, 0x3f, 0x3d, 0x27, 0x15, 0xa1, 0x0a,
	0x64, 0x5c, 0x71, 0x49, 0x62, 0x6e, 0x01, 0x44, 0x81, 0x92, 0x27, 0x17, 0x47, 0x48, 0x66, 0x6e,
	0xaa, 0x5b, 0x62, 0x66, 0x8e, 0x90, 0x2d, 0x17, 0x27, 0x48, 0x3a, 0xbe, 0x24, 0xb5, 0xb8, 0x44,
	0x82, 0x51, 0x81, 0x51, 0x83, 0xdb, 0x48, 0x4a, 0x0f, 0x62, 0x80, 0x1e, 0xcc, 0x00, 0xbd, 0x10,
	0x98, 0x01, 0x4e, 0x2c, 0x13, 0xee, 0xcb, 0x33, 0x06, 0x81, 0x1d, 0x18, 0x92, 0x5a, 0x5c, 0xe2,
	...
	0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x89, 0x0d, 0x6c, 0xb2, 0x31, 0x20, 0x00,
	0x00, 0xff, 0xff, 0x42, 0x1e, 0x22, 0x21, 0xf9, 0x00, 0x00, 0x00,
}
...
func (m *TimeFail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TimeTest != nil {
		n1, err1 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(*m.TimeTest, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(*m.TimeTest):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
...
func (m *TimeFail) Size() (n int) {
	...
	_ = l
	if m.TimeTest != nil {
		l = github_com_bittorrent_protobuf_types.SizeOfStdTime(*m.TimeTest)
...
func (m *TimeFail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_bittorrent_protobuf_types.StdTimeUnmarshal(m.TimeTest, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
