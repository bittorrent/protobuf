...
func BenchmarkCastawayProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_bittorrent_protobuf_proto.Marshal(NewPopulatedCastaway(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkWilsonProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_bittorrent_protobuf_proto.Marshal(NewPopulatedWilson(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
