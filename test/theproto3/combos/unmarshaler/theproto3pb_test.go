...
import (
	...
	_ "github.com/tron-us/protobuf/test/combos/both"
	go_parser "go/parser"
	math "math"
	math_rand "math/rand"
	testing "testing"
...
func BenchmarkMessageProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedMessage(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkNestedProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedNested(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkAllMapsProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedAllMaps(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkAllMapsOrderedProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedAllMapsOrdered(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkMessageWithMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedMessageWithMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkFloatingPointProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedFloatingPoint(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkUint128PairProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedUint128Pair(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkContainsNestedMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedContainsNestedMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkContainsNestedMap_NestedMapProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedContainsNestedMap_NestedMap(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkNotPackedProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_tron_us_protobuf_proto.Marshal(NewPopulatedNotPacked(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
