...
type Foo5 struct {
	Bar1    Bar1             `protobuf:"bytes,1,opt,name=bar1" json:"bar1" pg:"bar1"`
	Bar2    *Bar1            `protobuf:"bytes,2,opt,name=bar2" json:"bar2,omitempty" pg:"bar2"`
	Bar3    Bar2             `protobuf:"bytes,3,opt,name=bar3" json:"bar3" pg:"bar3"`
	Bar4    *Bar2            `protobuf:"bytes,4,opt,name=bar4" json:"bar4,omitempty" pg:"bar4"`
	Bars1   []Bar1           `protobuf:"bytes,5,rep,name=bars1" json:"bars1" pg:"bars1"`
	Bars2   []*Bar1          `protobuf:"bytes,6,rep,name=bars2" json:"bars2,omitempty" pg:"bars2"`
	Bars3   []Bar2           `protobuf:"bytes,7,rep,name=bars3" json:"bars3" pg:"bars3"`
	Bars4   []*Bar2          `protobuf:"bytes,8,rep,name=bars4" json:"bars4,omitempty" pg:"bars4"`
	Barrs1  []Bar3           `protobuf:"bytes,9,rep,name=barrs1" json:"barrs1" pg:"barrs1"`
	Barrs2  []Bar5           `protobuf:"bytes,10,rep,name=barrs2" json:"barrs2" pg:"barrs2"`
	Barmap1 map[string]*Bar3 `protobuf:"bytes,11,rep,name=barmap1" json:"barmap1,omitempty" pg:"barmap1" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Barmap2 map[string]*Bar5 `protobuf:"bytes,12,rep,name=barmap2" json:"barmap2,omitempty" pg:"barmap2" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
type Bar1 struct {
	Str string `protobuf:"bytes,1,opt,name=str" json:"str" pg:"str"`
}
...
type Bar2 struct {
	Str *string `protobuf:"bytes,1,opt,name=str" json:"str,omitempty" pg:"str"`
}
...
type Bar3 struct {
	Bars4 []Bar4 `protobuf:"bytes,1,rep,name=bars4" json:"bars4" pg:"bars4"`
	Bars2 []Bar2 `protobuf:"bytes,2,rep,name=bars2" json:"bars2" pg:"bars2"`
}
...
type Bar5 struct {
	Bars2 []*Bar2 `protobuf:"bytes,1,rep,name=bars2" json:"bars2,omitempty" pg:"bars2"`
	Bars1 []*Bar1 `protobuf:"bytes,2,rep,name=bars1" json:"bars1,omitempty" pg:"bars1"`
}
...
type Bar7 struct {
	Bars71 []Bar7  `protobuf:"bytes,1,rep,name=bars71" json:"bars71" pg:"bars71"`
	Bars72 []*Bar7 `protobuf:"bytes,2,rep,name=bars72" json:"bars72,omitempty" pg:"bars72"`
	Str1   string  `protobuf:"bytes,3,opt,name=str1" json:"str1" pg:"str1"`
	Str2   *string `protobuf:"bytes,4,opt,name=str2" json:"str2,omitempty" pg:"str2"`
}
...
type Bar8 struct {
	Bars1 []Bar9 `protobuf:"bytes,1,rep,name=bars1" json:"bars1" pg:"bars1"`
}
...
var fileDescriptor_c2447996d16f3907 = []byte{
	...
	,
}
...
func (this *Foo5) String() string {
	...
	github_com_bittorrent_protobuf_sortkeys.Strings(keysForBarmap1)
	...
	github_com_bittorrent_protobuf_sortkeys.Strings(keysForBarmap2)
